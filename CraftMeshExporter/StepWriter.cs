...
namespace CraftMeshExporter
{
    ...
    internal static class StepWriter
    {
        ...
        public static void Write(string file, List<Triangle> triangles, string craftName, float scale, Action<string> status)
        {
            ...
            Log.Info("[CraftMeshExporter] Wrote STEP: " + file + " (" + triangles.Count + " triangles)");
        }
        ...
        private static void WriteHeader(StreamWriter sw, string craftName, float scale)
        {
            ...
            sw.WriteLine("FILE_NAME(" + S(craftName) + "," + S(timestamp) + ",(" + S("CraftMeshExporter") + "),(" + S("Kerbal Space Program") + "),");
            sw.WriteLine("  " + S("CraftMeshExporter") + "," + S("Kerbal Space Program") + "," + S("") + ");");
