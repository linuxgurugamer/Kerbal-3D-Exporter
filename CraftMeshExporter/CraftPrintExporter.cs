    ...
    internal static class CraftPrintExporter
    {
            ...
            Action complete)
        {
                   ...
                   ctx.Stage != ExportStage.Cancelled)
            {
                ...
                {
                    Log.Error("[CraftMeshExporter] Export failed during stage " + ctx.Stage + ": " + ex);
        ...
        private static void WriteMeshDiagnostics(ExportContext ctx)
        {
            ...
            {
                Log.Error("[CraftMeshExporter] Failed writing mesh diagnostics: " + ex);
        ...
        private static void SafeRestoreShrouds(ExportContext ctx)
        {
            ...
            {
                Log.Error("[CraftMeshExporter] Failed restoring shrouds: " + restoreEx);
            }
        }
