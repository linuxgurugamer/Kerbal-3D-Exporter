...
namespace CraftMeshExporter
{
    ...
    {
        private const int TOTAL_PROGRESS_STEPS = 14;
            ...
            Action complete)
        {
                   ...
                   ctx.Stage != ExportStage.Cancelled)
            {
                ...
                {
                    Debug.LogError("[CraftMeshExporter] Export failed during stage " + ctx.Stage + ": " + ex);
        ...
        private static void StagePrepareOutput(ExportContext ctx)
        {
            ...
            if (string.IsNullOrEmpty(ctx.OutputDir))
                ctx.OutputDir = Path.Combine(KSPUtil.ApplicationRootPath, "GameData/CraftMeshExporter/Models");
        ...
        private static void StageWriteObj(ExportContext ctx)
        {
            ...
            SetProgress(ctx, ctx.ExportStl ? 11 : 9);
        }
        ...
        private static void StageWriteObjInstructions(ExportContext ctx)
        {
            ...
            ctx.Stage = ExportStage.RestoreShroudVisibility;
            SetProgress(ctx, ctx.ExportStl ? 12 : 10);
        }
        ...
        private static void WriteMeshDiagnostics(ExportContext ctx)
        {
            ...
            {
                Debug.LogError("[CraftMeshExporter] Failed writing mesh diagnostics: " + ex);
        ...
        private static void SafeRestoreShrouds(ExportContext ctx)
        {
            ...
            {
                Debug.LogError("[CraftMeshExporter] Failed restoring shrouds: " + restoreEx);
            }
        }
