...
namespace CraftMeshExporter
{
    ...
    public class CraftPrintExporterWindow : MonoBehaviour
    {
        ...
        private Rect windowRect = new Rect(300, 80, 760, 760);
        ...
        private string outputDirText = string.Empty;
        private string viewerExePathText = string.Empty;
        private bool openViewerAfterExport;
        ...
        public void Start()
        {
            outputDirText = GetDefaultOutputDirectory();
        }
        ...
        public void OnGUI()
        {
            ...
            if (showWindow)
                windowRect = ClickThruBlocker.GUILayoutWindow(WINDOW_ID, windowRect, DrawWindow, "Craft Print Exporter");
        }
        ...
        private void DrawWindow(int id)
        {
            using (new GUILayout.VerticalScope())
            {
                ...
                outputDirText = GUILayout.TextField(outputDirText);
                using (new GUILayout.HorizontalScope())
                {

                    GUI.enabled = GetDefaultOutputDirectory() != outputDirText;
                ...
                viewerExePathText = GUILayout.TextField(viewerExePathText);
        ...
        private void StartExport()
        {
            ...
            if (!exportStl && !exportObj)
            {
                AddStatus("Select STL, OBJ, or both.");
                return;
            }

            string outputDir = ResolveOutputDirectory(outputDirText);
        ...
        public void Open()
        {
            ...
            if (string.IsNullOrEmpty(outputDirText))
                outputDirText = GetDefaultOutputDirectory();
        ...
        {
            showWindow = false;
            CraftMeshExporterToolbarButton.NotifyWindowClosed();
        }
        ...
        {
            CraftPrintExporterWindow win = FindObjectOfType<CraftPrintExporterWindow>();
            return win != null && win.showWindow;
        }

        private static string GetDefaultOutputDirectory()
        {
            return Path.Combine(KSPUtil.ApplicationRootPath, "GameData/CraftMeshExporter/Models");
        }
