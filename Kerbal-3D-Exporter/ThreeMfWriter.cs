...
namespace Kerbal_3D_Exporter
{
    ...
    internal static class ThreeMfWriter
    {
            ...
            Dictionary<int, string> partNames)
        {
            ...
            Log.Info("Wrote 3MF: " + file + " (" + triangles.Count + " triangles, perPart=" + perPart + ")");
        }
            ...
            Dictionary<int, string> partNames)
        {
            ...
            sb.Append("  <metadata name=\"Designer\">Kerbal-3D-Exporter</metadata>\r\n");
            sb.Append("  <metadata name=\"Application\">Kerbal Space Program - Kerbal 3D Exporter</metadata>\r\n");
        ...
        private static string BuildModelXml(List<Triangle> triangles, string craftName, float scale)
        {
            ...
            sb.Append("  <metadata name=\"Title\">").Append(EscapeXml(craftName)).Append("</metadata>\r\n");
            sb.Append("  <metadata name=\"Designer\">KSP Kerbal 3D Exporter</metadata>\r\n");
            sb.Append("  <metadata name=\"Application\">Kerbal Space Program - Kerbal3D Exporter</metadata>\r\n");
            sb.Append("  <metadata name=\"Description\">Export scale ")
              .Append(F(scale))
